...
namespace fpnn
{
	...
	public:
		...
		*/
		...
		=============================================================================== */
		/*
		* Please using the IQuestProcessor to encapsulate the connected event and connection closed event.
		* Upper programming language using the 'EmbedRecvNotifyDelegate' interface to processing server push / duplex events.
		*/
